...
* [Cache replacement policies - FIFO](https://en.wikipedia.org/wiki/FIFO_(computing_and_electronics))
* [Cache replacement policies - LIFO](https://en.wikipedia.org/wiki/Stack_(abstract_data_type))
